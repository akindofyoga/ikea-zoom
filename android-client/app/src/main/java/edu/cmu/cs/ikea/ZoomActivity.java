...
public class ZoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!zoomSDK.isInitialized()) {
            ...
            initParams.appKey = intent.getStringExtra(GabrielActivity.EXTRA_APP_KEY);
            initParams.appSecret = intent.getStringExtra(GabrielActivity.EXTRA_APP_SECRET);
    ...
    private void startMeeting() {
        ...
        params.meetingNo = intent.getStringExtra(GabrielActivity.EXTRA_MEETING_NUMBER);
        params.password = intent.getStringExtra(GabrielActivity.EXTRA_MEETING_PASSWORD);
        meetingService.joinMeetingWithParams(ZoomActivity.this, params);
    }
