...
// From:
// https://github.com/zoom/zoom-sdk-android/blob/f4b5d088a6b388351a73aa0c58a539b4b3484951/mobilertc-android-studio/sample/src/main/java/us/zoom/sdksample/inmeetingfunction/customizedmeetingui/SimpleInMeetingListener.java
...
public abstract class SimpleInMeetingListener implements InMeetingServiceListener {
    ...
    @Override
    public void onMeetingNeedPasswordOrDisplayName(boolean b, boolean b1,
    ...
    @Override
    public void onFreeMeetingReminder(boolean isHost, boolean canUpgrade,
                                      boolean isFirstGift){
